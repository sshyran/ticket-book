                        ...
                        <tbody>
                            <c:forEach var="trip" items="${requestScope.tripList}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="ActionServlet?btAction=Manage Trip&action=update&id=${trip.id}" class="btn btn-success">
                                            Update
                                        </a>
                                    </td>
                                    <td>
                                        <a href="ActionServlet?btAction=Manage Trip&action=delete&id=${trip.id}" class="btn btn-danger">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
